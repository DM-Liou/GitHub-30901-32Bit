...
class AppFrame(wx.Frame):
    ...
    def __init__(self, *args, **kw):
        ...
        wx.StaticText(pnl, label='身分證帳號', pos=(11, 30))
...
if __name__ == "__main__":
    print()
    print('0. This name = main then GO')
    app = MyApp()
    frame = AppFrame(None, title='YuantaQuoteAPI Sample', size=(670, 370))
    frame.Show(True)
    print('1. START & END  設定顯示主劃面 程式庫: wx.App/wx.frame     class: MyApp() / class: AppFrame()')
    Bot = StockBot(frame.Handle)
    print('2. START & END  Bot = class StockBot(frame.Handle)    ')
    print()

  # -------3. LOOP........ 等待輸入帳號 -------------------------------------
    print('3. START        LOOP... 等待輸入帳號: app.MainLoop(run_job)')
    print()
